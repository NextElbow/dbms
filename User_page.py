...
def user():
    ...
    Button(root, text="  VIEW PLAYLISTS  ", font=("Comic Sans", 35, "bold"), fg="#6F4E37").place(x=350, y=230)
    # Create PLaylist button
    Button(root, text="CREATE PLAYLIST", font=("Comic Sans", 35, "bold"), fg="#6F4E37").place(x=350, y=400)
