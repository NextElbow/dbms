...
def add_songs():
    ...
    # Background Image
    bg = ImageTk.PhotoImage(file=r"C:\Users\maxso\PycharmProjects\DBMS_music-management\Wallpaper 4k My Best Casette Playlist 4k Wallpaper.jpg")
    ...
    Add_button = Button(root, text="ADD", fg="#FC46AA", font=("times new roman", 22)).place(x=400, y=530)
